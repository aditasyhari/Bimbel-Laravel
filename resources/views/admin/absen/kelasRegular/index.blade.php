                                        ...
                                        @foreach($kelas as $kel)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form id="delForm{{ $a->id }}" action="{{ route('absen-siswa-regular.destroy', ['absen_siswa_regular' => $a->id]) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
                                                </td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('absen-siswa-regular.store') }}">
                            @csrf
