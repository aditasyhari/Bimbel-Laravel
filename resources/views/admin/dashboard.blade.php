                        ...
                        <div class="card-content">
                            <div class="card-body text-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="m-auto w-75">You have done <strong>57.6%</strong> more sales today. Check
                ...
                <div class="col-lg-4 col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-start">
                            ...
                            <p class="mb-0"><i
                                    class="feather icon-more-vertical font-medium-3 text-muted cursor-pointer"></i></p>
                        </div>
                        <div class="card-content">
                                                ...
                                                <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        <img class="media-object rounded-circle"
                                                            src="{{asset('app-assets/images/portrait/small/avatar-s-5.jpg')}}"
                                                    ...
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar pull-up">
                                                        <img class="media-object rounded-circle"
                                                            src="{{asset('app-assets/images/portrait/small/avatar-s-7.jpg')}}"
                                                            alt="Avatar" height="30" width="30">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar pull-up">
                                                        <img class="media-object rounded-circle"
                                                            src="{{asset('app-assets/images/portrait/small/avatar-s-10.jpg')}}"
                                                            alt="Avatar" height="30" width="30">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                            ...
                                            <td class="p-1">
                                                <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                    ...
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar pull-up">
                                                        <img class="media-object rounded-circle"
                                                            src="{{asset('app-assets/images/portrait/small/avatar-s-2.jpg')}}"
                                                            alt="Avatar" height="30" width="30">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                            ...
                                            <td class="p-1">
                                                <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                                    ...
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                        ...
                                                        class="avatar pull-up">
                                                        <img class="media-object rounded-circle"
                                                            src="{{asset('app-assets/images/portrait/small/avatar-s-9.jpg')}}"
                                                            alt="Avatar" height="30" width="30">
                                                    </li>
                                                </ul>
                                            </td>
