...
<head>
    ...
    <meta name="csrf-token" content="XeZBy1eLwLDoDT3BRnATmGRUZFwlj7zI6s1L3UEN">
                                ...
                                <div class="header-info-left">
                                    <ul>
                                        <li>
                                            ...
                                            <i class="fas fa-user-circle"></i><a href="{{ url('login') }}">Login</a> |
                                            <a href="{{ url('register') }}">Register</a>
                                        </li>
                                        <li class="hide-mobile"><i class="fas fa-map-marker-alt"></i>Jl. Dewi Sartika
                                        </li>

                                        <li class="hide-mobile"><i class="fas fa-envelope"></i>info@email.com</li>

                                    </ul>
                                </div>
                                <div class="header-info-right    d-md-none"><a href="{{ url('keranjang') }}"><i
                                            class="fa fa-cart-plus"></i> Cart</a></div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-3">
                                <div class="header-right-btn f-right d-none d-lg-block">
                                    <a href="http://traineasyv3.intermaticsng.com/cart"
                                        style="padding: 18px 22px;    text-align: center;" class="tbtn header-btn"><i
                                            class="fa fa-cart-plus"></i> Your Cart</a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap text-center">
                                <h2>Detail Kelas</h2>
                                <p class="crumb">
                                    <span><a href="http://traineasyv3.intermaticsng.com">Home</a></span>
                                    <span>/</span>
                                    <span><a href="http://traineasyv3.intermaticsng.com/courses">Courses</a></span>
                                    <span>/</span>
                                    <span><a href="#">Course Details</a></span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                <img class="rounded img-fluid img-thumbnail"
                                    src="http://traineasyv3.intermaticsng.com/tmp/cache/usermedia/practice-javascript-and-learn-functions-400x277-400x300.png">
                            </div>
                            <div class="col-md-8">
                                ...
                                <a class="btn btn-primary  btn-lg" href="{{ url('keranjang') }}"><i
                                        class="fa fa-cart-plus"></i> Enroll ($ 0.00) </a>
                            </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-md-8">
                                ...
                                <div class="tab-content" id="myTabContent2">
                                    <div class="tab-pane fade show active" id="home3" role="tabpanel"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <p>Don&rsquo;t sell yourself short: learn to attract customers and close
                                                    sales by mastering skills such as persuasion, lead generation, sales
                                                    calls and meetings. While using the traditional selling tenets as a
                                                    foundation, you will look at adapting the concepts to the rapidly
                                                    changing world of business, including the use of Twitter, LinkedIn,
                                                    Facebook, blogs, wikis, and other interactive ways of connecting
                                                    with customers. The ability to negotiate effectively is an art form
                                                    which many of us are not confident in doing. Formal negotiations are
                                                    however, a vital part of communication across various sectors from
                                                    business to politics. Our sales courses will be of interest to all
                                                    professionals in many varied sectors such as business,
                                                    entrepreneurship, human resources and management who are looking for
                                                    guidance on the art and practise of successful negotiation.</p>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <a href="#">
                                                            <img class="img-fluid  rounded"
                                                                src="http://traineasyv3.intermaticsng.com/tmp/cache/usermedia/6/cold-calling_720-300x300.jpg">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <article class="readmore">
                                                            <p>Key skills required for cold calling</p>
                                                        </article>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="author-box-left">
                                                            <img alt="image"
                                                                src="http://traineasyv3.intermaticsng.com/tmp/cache/usermedia/student_uploads/2020_12/16069996934_UeZqf6hGgPjmlxiua5bz9LaoA8tSg3jH3l4pEs6F-300x300.jpeg"
                                                                class="rounded-circle img-fluid author-box-picture">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="author-box-details">
                                                            ...
                                                            <div class="author-box-job">Super Administrator</div>
                                                            <div class="author-box-description">
                                                                <p>I am a skilled an qualified instructor</p>
                                                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <a class="btn btn-primary btn-block btn-lg" href="{{ url('login') }}"><i
                                        class="fa fa-cart-plus"></i> Enroll</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <a class="btn btn-primary  btn-lg"
                                    href="http://traineasyv3.intermaticsng.com/cart/add/5"><i
                                        class="fa fa-cart-plus"></i> Enroll ($ 0.00) </a>
                            </div>
